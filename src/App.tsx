  ...
  return (
    <GridBackground>
      ...
      <div className="min-h-screen md:pt-20">
        ...
        <section className="relative h-screen flex flex-col justify-center items-center text-center px-4 overflow-hidden">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="bg-red-200 bg-opacity-50 px-4 py-6 md:py-10 rounded-lg md:ml-6 w-full max-w-sm md:max-w-none">
              ...
              <p className="text-xl md:text-4xl text-white max-w-2xl mx-auto">
                Caffeine required
              </p>
            </div>
          </div>
        ...
        {/* Trailer Section */}
        <section className="py-20 h-screen px-4">
          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center gap-16">
            ...
            <div className="flex flex-col md:flex-row gap-12 w-full items-center">
              ...
              <div className="flex-1 flex flex-col gap-6">
                ...
                <button className="btn btn-3xl btn-primary w-full justify-center h-16 text-3xl">
                  Download for PCVR
                </button>
                <button className="btn btn-3xl btn-secondary w-full justify-center h-16 text-3xl">
        ...
        <section className="py-20 h-screen px-4">
          <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center ">
            ...
            <div className="flex-1 text-left text-white space-y-3 max-w-4xl">
              <p className="text-lg sm:text-xl md:text-3xl leading-relaxed drop-shadow-md">
              ...
              <p className="text-lg sm:text-xl md:text-3xl font-semibold drop-shadow-md">
        ...
        {/* About Game Section */}
        <section className="pt-20 pb-8 px-4 bg-red-200">
          <div className="px-20 mx-auto flex flex-col gap-12">
